...
(3) Stellt der Hauptwahlvorstand fest, dass die Amtszeit eines Delegierten 1.durch Niederlegung des Amtes,2.durch Beendigung der Beschäftigung des Delegierten in dem Betrieb, dessen Delegierter er ist,3.durch Verlust der Wählbarkeitvorzeitig beendet (§ 14 Abs. 1 des Gesetzes) oder dass er verhindert (§ 14 Abs. 2 Satz 1 des Gesetzes) ist, so verständigt er den Ersatzdelegierten (§ 14 Abs. 2 Satz 2 des Gesetzes) in gleicher Weise wie die Delegierten.
