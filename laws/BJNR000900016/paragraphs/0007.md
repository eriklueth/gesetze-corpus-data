...
(1) Der Jahresbeitrag wird nach der folgenden Formel berechnet: Ci = max {MCi ; (CR x ARWi x CDi x µ)} Die Faktoren haben folgende Bedeutung: Ci =Jahresbeitrag des CRR-Kreditinstituts,MCi =Mindestbeitrag gemäß § 5 Absatz 2,CR =Beitragsrate,ARW =aggregiertes Risikogewicht des CRR-Kreditinstituts,CD =gedeckte Einlagen des CRR-Kreditinstituts,µ =Korrekturfaktor.Der Jahresbeitrag ist der höhere Betrag, entweder der Mindestbetrag MCi oder das Ergebnis der Formel CR x ARWi x CDi x µ.
