...
(2) Dokumente, die in Papierform erstellt wurden, können verwahrt werden als 1.elektronische Fassung (§ 56 des Beurkundungsgesetzes),2.elektronisch beglaubigte Abschrift, wenn es sich bei ihnen um Ausfertigungen, beglaubigte Abschriften oder einfache Abschriften handelt, oder3.elektronische Abschriften, wenn es sich bei ihnen um einfache Abschriften handelt.

(3) Dokumente, die in elektronischer Form erstellt wurden, können in dieser Form oder als elektronische Fassung des Ausdrucks, der in der Urkundensammlung verwahrt wird, verwahrt werden. In der Form, in der sie erstellt wurden, sind zu verwahren: 1.elektronische Niederschriften und2.einfache elektronische Zeugnisse im Sinne des § 39a des Beurkundungsgesetzes, wenn das zu ihrer Errichtung erstellte elektronische Dokument in notarieller Verwahrung verbleibt.
