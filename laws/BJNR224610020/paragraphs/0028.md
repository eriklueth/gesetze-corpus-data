...
(1) Zu jedem Notaranderkonto sind einzutragen 1. das Kreditinstitut unter Angabe des Sitzes und des Bank Identifier Codes (BIC), 2. die International Bank Account Number (IBAN), 3. die Währung, in der das Notaranderkonto geführt wird, sowie 4. die Angabe, ob es sich um ein Giro- oder um ein Festgeldkonto handelt.
