...
type: paragraph
number: "§ 176e"
heading: Verbreitung und Besitz von Anleitungen zu sexuellem Missbrauch von Kindern
breadcrumb:
  - Allgemeiner Teil
  - Besonderer Teil
...
(2) <sup>1</sup>Ebenso wird bestraft, wer 1. einen Inhalt (§ 11 Absatz 3), der geeignet ist, als Anleitung zu einer in den §§ 176 bis 176d genannten rechtswidrigen Tat zu dienen, verbreitet oder der Öffentlichkeit zugänglich macht oder 2. öffentlich oder in einer Versammlung zu einer in den §§ 176 bis 176d genannten rechtswidrigen Tat eine Anleitung gibt, <sup>2</sup>um die Bereitschaft anderer zu fördern oder zu wecken, eine solche Tat zu begehen.
