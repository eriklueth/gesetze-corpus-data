...
type: paragraph
number: "§ 2a"
heading: Datenübermittlung an die Waffenbehörden
breadcrumb: []
...
(2) Das automatisierte Fachverfahren ermöglicht die Datenübermittlung über 1. ein Meldeportal (Web-Portal) und 2. eine automatisierte Schnittstelle (Web-Service).
