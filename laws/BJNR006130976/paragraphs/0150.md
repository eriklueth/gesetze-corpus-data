...
type: paragraph
number: "§ 150"
heading: Form und Inhalt der Steuererklärungen
breadcrumb:
...
(1) Eine Steuererklärung ist nach amtlich vorgeschriebenem Vordruck abzugeben, wenn 1.keine elektronische Steuererklärung vorgeschrieben ist,2.nicht freiwillig eine gesetzlich oder amtlich zugelassene elektronische Steuererklärung abgegeben wird,3.keine mündliche oder konkludente Steuererklärung zugelassen ist und4.eine Aufnahme der Steuererklärung an Amtsstelle nach § 151 nicht in Betracht kommt.§ 87a Absatz 1 Satz 1 ist nur anzuwenden, soweit eine elektronische Steuererklärung vorgeschrieben oder zugelassen ist. Der Steuerpflichtige hat in der Steuererklärung die Steuer selbst zu berechnen, soweit dies gesetzlich vorgeschrieben ist (Steueranmeldung).
