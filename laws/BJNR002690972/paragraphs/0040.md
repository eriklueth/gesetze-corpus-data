...
(1) Die Geschwindigkeit, mit der ein Zug höchstens fahren darf (zulässige Geschwindigkeit), ist abhängig von 1.der Bauart der einzelnen Fahrzeuge,2.der Art und Länge der Züge (§ 34),3.den Bremsverhältnissen (§ 35),4.den Streckenverhältnissen,5.den betrieblichen Verhältnissenund von den Vorschriften der folgenden Absätze.
...
(7) In Gleisbogen darf die Geschwindigkeit von Zügen ohne Rollfahrzeuge betragen 1.bei dem Grundmaß der Spurweite von 1.000 mm: R 1,5 V = Wurzel aus ---- x (ü x ---- + 130) 11,8 1,02.bei dem Grundmaß der Spurweite von 750 mm: R 1,5 V = Wurzel aus ---- x (ü x ---- + 130) 11,8 0,75V = Geschwindigkeit in km/hR = Bogenhalbmesser in mü = Überhöhung in mm.
