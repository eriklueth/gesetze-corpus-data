...
type: paragraph
number: "§ 27"
heading: Risikobewertung; Informationsaustausch
breadcrumb:
...
(2) Die Bundesanstalt teilt den zuständigen Behörden eines Aufnahmemitgliedstaats sowie eines etwaig davon abweichenden Vertragsstaats, in dem der Kredit gewährt wurde, Folgendes mit: 1. die Ergebnisse der Bewertung nach Absatz 1 Satz 1, wenn eine dieser zuständigen Behörden darum ersucht oder die Bundesanstalt es für angebracht hält, sowie 2. stets nähere Angaben zu etwaigen Maßnahmen und Sanktionen, die gegen das Kreditdienstleistungsinstitut im Bewertungszeitraum ergriffen oder verhängt wurden.
