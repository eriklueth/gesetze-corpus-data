...
(2) Enthält die Leistungsbeschreibung Leistungs- oder Funktionsanforderungen, so darf der öffentliche Auftraggeber ein Angebot nicht ablehnen, wenn diese Anforderungen die von ihm geforderten Leistungs- oder Funktionsanforderungen betreffen und das Angebot Folgendem entspricht: 1. einer nationalen Norm, mit der eine europäische Norm umgesetzt wird, 2. einer Europäischen Technischen Bewertung, 3. einer gemeinsamen technischen Spezifikation, 4. einer internationalen Norm oder 5. einem technischen Bezugssystem, das von den europäischen Normungsgremien erarbeitet wurde. Das Unternehmen muss in seinem Angebot belegen, dass die jeweilige der Norm entsprechende Liefer- oder Dienstleistung den Leistungs- oder Funktionsanforderungen des öffentlichen Auftraggebers entspricht. Belege können insbesondere eine technische Beschreibung des Herstellers oder ein Prüfbericht einer anerkannten Stelle sein.
