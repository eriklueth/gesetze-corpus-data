...
(2) Die Übertragung oder Begründung von Rentenanwartschaften zugunsten von Versicherten führt zu einem Zuschlag an Entgeltpunkten. Der Begründung von Rentenanwartschaften stehen gleich 1.die Wiederauffüllung geminderter Rentenanwartschaften (§ 187 Abs. 1 Nr. 1),2.die Abwendung einer Kürzung der Versorgungsbezüge, wenn später eine Nachversicherung durchgeführt worden ist (§ 183 Abs. 1).
