...
(2) Bei Überlassung und Erwerb sind zusätzlich anzuzeigen 1. folgende Daten des Erwerbers: a) Familienname, b) Vorname, c) Geburtsdatum, d) Geburtsort, e) Anschrift; 2. bei Nachweis der Erwerbs- und Besitzberechtigung durch eine Waffenbesitzkarte: a) die Nummer der Waffenbesitzkarte und b) die ausstellende Behörde; 3. folgende Daten des Überlassenden: a) Familienname, b) früherer Name, c) Geburtsname, d) Vorname, e) Doktorgrad, f) Geburtsdatum, g) Geburtsort, h) Geschlecht, i) jede Staatsangehörigkeit sowie j) Anschrift.
