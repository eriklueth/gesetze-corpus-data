...
(2) Diensteanbieter, die Nutzern einen Internetzugang über ein drahtloses lokales Netzwerk zur Verfügung stellen, dürfen von einer Behörde nicht verpflichtet werden, 1.vor Gewährung des Zugangs a)die persönlichen Daten von Nutzern zu erheben und zu speichern (Registrierung) oderb)die Eingabe eines Passworts zu verlangen oder2.das Anbieten des Dienstes dauerhaft einzustellen.Diensteanbieter können jedoch auf freiwilliger Basis die Nutzer identifizieren, eine Passworteingabe verlangen oder andere freiwillige Maßnahmen ergreifen.
