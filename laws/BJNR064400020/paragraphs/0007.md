...
type: paragraph
number: "§ 7"
heading: Allgemeine Vorgaben zu Indikatoren
breadcrumb:
...
(3) Die Indikatoren müssen mindestens folgende Kategorien abdecken: 1. Kapital, 2. Liquidität, 3. Rentabilität und 4. Qualität der Vermögenswerte. Weitere Kategorien sind durch 1. marktbasierte Indikatoren und 2. makroökonomische Indikatoren abzudecken, es sei denn, das Institut kann im Sanierungsplan nachvollziehbar begründen, dass die entsprechende Kategorie aufgrund seiner Rechtsform, seines Risikoprofils, seiner Größe oder seiner Komplexität nicht relevant ist.
