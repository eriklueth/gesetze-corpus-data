...
(1) Ein qualifizierter Plattformbetreiber ist ein Plattformbetreiber, 1.der in einem qualifizierten Drittstaat ansässig ist und2.bei dem sämtliche relevante Tätigkeiten, deren Erbringung die von ihm betriebene Plattform ermöglicht, qualifizierte relevante Tätigkeiten sind.Eine Ansässigkeit in einem qualifizierten Drittstaat liegt vor, wenn der Plattformbetreiber in einem qualifizierten Drittstaat nach den dort geltenden Rechtsvorschriften 1.steuerlich ansässig ist oder2.steuerlich nicht ansässig ist, aber a)nach dem Recht des qualifizierten Drittstaats eingetragen ist oderb)den Ort seiner tatsächlichen Geschäftsleitung in dem qualifizierten Drittstaat hat.

(2) Ein qualifizierter Drittstaat ist ein Drittstaat, 1.zwischen dem und allen Mitgliedstaaten der Europäischen Union eine qualifizierte Vereinbarung besteht und2.der alle Mitgliedstaaten der Europäischen Union öffentlich als meldepflichtige Staaten benannt hat.
